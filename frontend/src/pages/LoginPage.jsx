            ...
            <div className="space-y-4 text-left bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              {isAdmin ? (
                <>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">✓</div>
                    <span className="text-white/90">Review adoption requests</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">✓</div>
                    <span className="text-white/90">Update shelter profile</span>
                  </div>
                </>
              ) : (
                <>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? (
                  ...
                  <>
                    {isAdmin ? <Shield className="w-5 h-5" /> : <Heart className="w-5 h-5" />}
                    Sign In
                  </>
                )}
              </button>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 text-center">
              <button 
                ...
                className="text-sm text-gray-600 hover:text-[#FF8C42] font-medium transition-colors"
              >
                {isAdmin 
                  ? '← Switch to Adopter Login' 
                  : '→ Are you a Shelter Admin?'
                }
              </button>
            </div>
